...
import IndexLayout, { loader as indexLayoutLoader } from "../layouts/indexLayout";
...
export const router = createBrowserRouter([
    ...
    {
        path: "/dash", loader: indexLayoutLoader,
        element: <IndexLayout />,
        errorElement: <ErrorPage />,
        children: [
            { index: true, loader: () => { return redirect("/dash/index") } },
            {
                path: "index", element: <Index></Index>
            },
            {
                path: "website", element: <Website></Website>
            },
            {
                path: "database", element: <Database></Database>
            },
            {
                path: "file", element: <File></File>
            },
            {
                path: "terminal", element: <Terminal></Terminal>
            },
            {
                path: "mount", element: <Mount></Mount>
            },
        ],
    },
    { path: "/api" }
